  ...
  return (
    <div className={cn('flex flex-col items-center px-4 pt-6', isMobile && 'pt-4')}>
      <div className='ml-[-32px] flex w-full max-w-[672px] gap-3'>
        <img src={appId === '0e227844-dd40-465b-bb2c-3aee24e0bba3' ? avatar.src : avatarPurchase.src} alt="avatar" className="h-[64px] w-[64px] shrink-0 rounded-full border border-[#E9EBF2] bg-white" />
        <div className={cn(
